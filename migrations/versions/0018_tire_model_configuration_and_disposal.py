...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("equipment_model_id", "size", name="uq_tire_model_size"),
    )
    op.create_index("ix_tire_model_sizes_model", "tire_model_sizes", ["equipment_model_id"])
    op.create_table(
        "tire_system_settings",
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column("validity_years", sa.Integer(), nullable=False, server_default="3"),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
    )
    op.execute(
        "INSERT INTO tire_system_settings (id, validity_years, created_at, updated_at) "
    ...
    op.create_table(
        ...
        sa.Column("disposal_document", sa.String(100), nullable=False),
        sa.Column("reason", sa.String(250), nullable=False),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.UniqueConstraint("tire_id", name="uq_tire_disposal_tire"),
    )
