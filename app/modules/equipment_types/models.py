...
class EquipmentCategory(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("code", name="uq_equipment_category_code"),)
...
class EquipmentModel(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("equipment_type_id", "brand_id", "name", name="uq_model_per_type_brand"),)
    id = Column(Integer, primary_key=True, index=True)
