...
class EquipmentTypeCreate(BaseModel):
    name: str; measurement_unit: str; category_id: int; technical_library_category_id: Optional[int] = None; theoretical_quantity: Optional[int] = None
...
class EquipmentTypeOut(BaseModel):
    model_config = ConfigDict(from_attributes=True)
    id: int; name: str; measurement_unit: str; theoretical_quantity: Optional[int] = None; category_id: Optional[int] = None; technical_library_category_id: Optional[int] = None; is_frozen: bool
